...
jQuery('#kt_notes_panel_close3').on("click", function(e){
  jQuery('#kt_notes_panel3').removeClass('offcanvas-on');
...
jQuery('.create-login').on("click",function(){
...
jQuery('.kt_notes_panel_close').on("click", function(e){
  ...
  jQuery('.loginpopup').removeClass('offcanvas-on');
